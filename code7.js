...
gdjs.cloudCutsceneCode.asyncCallback18666220 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.cloudCutsceneCode.asyncCallback18666220(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.cloudCutsceneCode.asyncCallback18664188 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.cloudCutsceneCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(15), (runtimeScene) => (gdjs.cloudCutsceneCode.asyncCallback18664188(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.cloudCutsceneCode.asyncCallback18668844 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.cloudCutsceneCode.localVariables);
gdjs.cloudCutsceneCode.localVariables.length = 0;
}
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.cloudCutsceneCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.cloudCutsceneCode.asyncCallback18668844(runtimeScene, asyncObjectsList)));
}
}
