...
gdjs.outSideLabCode.asyncCallback18168268 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.outSideLabCode.asyncCallback18168268(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.outSideLabCode.asyncCallback18164212 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.outSideLabCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.outSideLabCode.asyncCallback18164212(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.outSideLabCode.asyncCallback18171708 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.outSideLabCode.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.outSideLabCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.outSideLabCode.asyncCallback18171708(runtimeScene, asyncObjectsList)));
}
}
